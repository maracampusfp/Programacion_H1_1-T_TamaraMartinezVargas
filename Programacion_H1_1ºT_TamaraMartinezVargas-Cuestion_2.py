...
while partidas_perdidas<3 and partidas_ganadas<3:
    ...
    if opc_jugador>0 and opc_jugador<4:
        ...
        # Papel contra Piedra, o Tijera contra Papel.
            ...
            # Si el jugador ha ganado 3 partidas, se informa
            if partidas_ganadas==3:
                print("Ya has ganado 3 partidas.")
                # Se detiene el juego cambiando la opc_jugador a un valor fuera del rango de valores que cumplen
                # la condición del bucle while para romper el bucle y finalizar el proceso.
                opc_jugador=8
